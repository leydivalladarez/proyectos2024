 ...
 */
package pkg_restful_LPV.service;
...
import pkg_restful_LPV.Facturacion;
 ...
 */
@Stateless
@Path("pkg_restful_lpv.facturacion")
public class FacturacionFacadeREST extends AbstractFacade<Facturacion> {

    @PersistenceContext(unitName = "prj_restfulPU")
    private EntityManager em;

    public FacturacionFacadeREST() {
